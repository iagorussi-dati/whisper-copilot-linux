...
### 3. Com instruções do usuário (10)
"me faz rir", "resume", "traduz", "o que perguntar?", "me dá argumentos", "fala como X", "explica pra leigo", etc.
- Critério: seguir a instrução, manter tom natural

### 4. Modo full (10)
Mesmos cenários dos lotes 1-3 mas no modo full (300 tokens).
- Critério: resposta mais completa mas ainda natural, sem virar relatório

### 5. Transmissões/YouTube/Twitch (10)
...
### 6. Respeito ao tamanho de resposta (10)
